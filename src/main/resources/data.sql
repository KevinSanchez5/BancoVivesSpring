...
VALUES ('1e4b41d8-9d4c-4321-ade7-3c8a843626e2', 'LmHVMAzSSYbddoR3qBd', 'CUENTA JUVENIL', 'Descripción cuenta juvenil', 0.005, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), false);

INSERT INTO account_type(id, public_id, name, description, interest, created_at, updated_at, is_deleted)
VALUES ('c56a4180-65aa-42ec-a945-5fd21dec0538', 'NqHVMAzSSYcddpT2qAd', 'CUENTA EMPRESARIAL', 'Descripción cuenta empresarial', 0.02, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), false);

INSERT INTO account_type(id, public_id, name, description, interest, created_at, updated_at, is_deleted)
VALUES ('e02fa0e4-01ad-400f-9c98-68cd3f4d3a3f', 'OkIVMAzSSYeddqV4rCd', 'CUENTA VIP', 'Descripción cuenta VIP', 0.03, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), false);

INSERT INTO account_type(id, public_id, name, description, interest, created_at, updated_at, is_deleted)
VALUES ('8c698f22-3ee4-11ee-89da-0242ac120002', 'PkJVMAzSSYgddnU5rEd', 'CUENTA FAMILIAR', 'Descripción cuenta familiar', 0.01, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), false);

INSERT INTO account_type(id, public_id, name, description, interest, created_at, updated_at, is_deleted)
VALUES ('64c283f0-bb2e-4c8f-bd2d-3b60c860ef79', 'QkKVVAzSSYhddoW6sFd', 'CUENTA ESTUDIANTIL', 'Descripción cuenta estudiantil', 0.0075, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), false);
