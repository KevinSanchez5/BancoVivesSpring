...
/* Cuentas */
INSERT INTO accounts(id, iban, balance, password, account_type, created_at, updated_at, is_deleted)
VALUES ('96257eff-0484-4a87-9509-51a9f24daf64', 'ES71CU4N1759HNCGUNQSNXM6', 0.0, 'JAKARTA24', '1e4b41d8-9d4c-4321-ade7-3c8a843626e2', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), false);

INSERT INTO accounts(id, iban, balance, password, account_type, created_at, updated_at, is_deleted)
VALUES ('a6f20974-a880-46b6-8b6d-069694eeaf60', 'ES51W8N4JVONAWK5B6ZA50OV', 0.0, 'JAKARTA26', '1e4b41d8-9d4c-4321-ade7-3c8a843626e2', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), false);
